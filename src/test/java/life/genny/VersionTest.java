...
//	@Test
	...
	{
		log.info("------------- qwanda-services version ---------------------------\n");
		
		log.info("Version:\t"+QwandaServicesVersion.getVersion());
		log.info("Build:  \t"+QwandaServicesVersion.getBuildDate());
		log.info("Commit: \t"+QwandaServicesVersion.getCommitDate());
